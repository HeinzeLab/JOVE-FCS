...
data = tttrlib.TTTR("DNA10bpPIE.ptu", 'PTU')  # file to be processed, filetype
...
crosscorrelation_curve_fine = functions_slice.correlate_pieces(
    macro_times=macro_times,
...
correlation_amplitudes = crosscorrelation_curve_fine[:, 1, :]
...
time_axis = crosscorrelation_curve_fine[0, 0]
time_axis_acf = autocorr_curve_ch1[0, 0] * macro_time_calibration_ms
...
p.semilogx(time_axis_acf, avg_curve_ch1, label='ACF1')
p.semilogx(time_axis_acf, avg_curve_ch2, label='ACF2')
