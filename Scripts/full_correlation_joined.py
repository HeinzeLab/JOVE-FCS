...
for ds in data_sets:
    ...
    cross_list.append(np.array(crosscorrelation_curve_fine))
...
time_axis = correlation_amplitude[0, 0, :]
time_axis_acf = autocorr1_amplitude[0, 0, :] * macro_time_calibration_ms
...
p.semilogx(time_axis_acf, avg_curve_ch1, label='gs-gs')
p.semilogx(time_axis_acf, avg_curve_ch2, label='gp-gp')
